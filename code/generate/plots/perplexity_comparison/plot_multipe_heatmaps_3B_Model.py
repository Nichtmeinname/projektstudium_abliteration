...
if __name__ == "__main__":
    ...
    model_name = "Qwen2.5-3B-Instruct_abliterated_norm_preserving"
    ...
    model_name = "Qwen2.5-3B-Instruct_abliterated_standard"
    weights_modified = "_Modified_Attn_O___MLP_DOWN"
    ...
    model_name = "Qwen2.5-3B-Instruct_abliterated_norm_preserving"
    weights_modified = "_Modified_Attn_Q_K_V___MLP_GATE_UP"

    plot_perplexity_heatmaps(
        f"../../../../data/responses/Qwen/{model_name}/Quantization/Modified_Self_Attn_Q_K_V___MLP_GATE_UP/harmful_prompts_seed_42.csv",
        f"Kategorie-Perplexity-Tabelle für {model_name}{weights_modified}\nUnethische Anfragen",
        f"Response-Perplexity-Tabelle für {model_name}{weights_modified}\nUnethische Anfragen",
        f"../../../../data/images/heatmap/category_perplexity/{model_name}/",
        f"{model_name}{weights_modified}_harmful.png",
    ...
    plot_perplexity_heatmaps(
        f"../../../../data/responses/Qwen/{model_name}/Quantization/Modified_Self_Attn_Q_K_V___MLP_GATE_UP/harmless_prompts_seed_42.csv",
        f"Kategorie-Perplexity-Tabelle für {model_name}{weights_modified}\nHarmlose Anfragen",
        f"Response-Perplexity-Tabelle für {model_name}{weights_modified}\nHarmlose Anfragen",
        f"../../../../data/images/heatmap/category_perplexity/{model_name}/",
        f"{model_name}{weights_modified}_harmless.png",
    ...
    model_name = "Qwen2.5-3B-Instruct_abliterated_norm_preserving"
    weights_modified = "_Modified_Attn_Q_K_V_O___MLP_DOWN_GATE_UP"

    plot_perplexity_heatmaps(
        f"../../../../data/responses/Qwen/{model_name}/Quantization/Modified_Self_Attn_Q_K_V_O___MLP_DOWN_GATE_UP/harmful_prompts_seed_42.csv",
        f"Kategorie-Perplexity-Tabelle für {model_name}{weights_modified}\nUnethische Anfragen",
        f"Response-Perplexity-Tabelle für {model_name}{weights_modified}\nUnethische Anfragen",
        f"../../../../data/images/heatmap/category_perplexity/{model_name}/",
        f"{model_name}{weights_modified}_harmful.png",
    ...
    plot_perplexity_heatmaps(
        f"../../../../data/responses/Qwen/{model_name}/Quantization/Modified_Self_Attn_Q_K_V_O___MLP_DOWN_GATE_UP/harmless_prompts_seed_42.csv",
        f"Kategorie-Perplexity-Tabelle für {model_name}{weights_modified}\nHarmlose Anfragen",
        f"Response-Perplexity-Tabelle für {model_name}{weights_modified}\nHarmlose Anfragen",
        f"../../../../data/images/heatmap/category_perplexity/{model_name}/",
        f"{model_name}{weights_modified}_harmless.png",
