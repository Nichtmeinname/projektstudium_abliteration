...
CONFIG = {
    ...
    "qwen2.5-3B-Abliterated - Modified Attention Q, K, V, O, MLP UP, GATE, DOWN": [
        "../../../../data/responses/Qwen/Qwen2.5-3B-Instruct_abliterated_standard/Quantization/Modified_Self_Attn_Q_K_V_O___MLP_DOWN_GATE_UP/harmful_prompts_seed_42.csv"
    ],
    "qwen2.5-3B-Abliterated - Modified Attention Q, K, V, MLP UP, GATE": [
        "../../../../data/responses/Qwen/Qwen2.5-3B-Instruct_abliterated_standard/Quantization/Modified_Self_Attn_Q_K_V___MLP_GATE_UP/harmful_prompts_seed_42.csv"
    ]
}

OUTPUT_FILE_PATH = "../../../../data/images/model_comparison/"
OUTPUT_FILE_NAME = "abliteration_standard_different_modified_weights_Qwen_3B_only_harmful_comparison.png"
...
def main():
    ...
    plot_refusal_scores(
        ...
        OUTPUT_FILE_PATH,
        OUTPUT_FILE_NAME,
        "Vergleich Qwen-3B-Instruct-Abliterated-Standard (nur Unethische Anfragen):\n Unterschiedlich modifizierte Gewichte\n n=" + str(
            sum(aggregated[
