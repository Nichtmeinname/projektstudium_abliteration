...
anschließend als Umgebungsvariable gesetzt
werden (https://huggingface.co/docs/huggingface_hub/package_reference/environment_variables#hftoken).
...
- GPU
    - Bei 3B Parametern wird mindestens eine Grafikkarte mit 8 GB oder 4 GB bei 4-Bit Quantisierung benötigt.
    - Bei 7B Parametern wird mindestens eine Grafikkarte mit 16 GB oder 8 GB bei 4-Bit Quantisierung benötigt.
- CPU
    - Bei 3B Parametern wird mindestens 16 GB RAM oder 8 GB RAM bei 4-Bit Quantisierung benötigt.
    - Bei 7B Parametern wird mindestens 32 GB RAM oder 16 GB RAM bei 4-Bit Quantisierung benötigt.